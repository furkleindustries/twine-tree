...
export const strings = {
  CHILDREN_INVALID:
    'The children argument passed to the HtmlStyleElementSyntaxNode ' +
    'constructor was not an array with a single member.',

  CHILD_INVALID:
    'The single member of the children argument passed to the ' +
    'HtmlStyleElementSyntaxNode constructor was neither a string nor did it meet ' +
    'the isStylesheet type guard.',

  SOURCE_INVALID:
    'The source argument passed to the HtmlStyleElementSyntaxNode constructor ' +
    'was not a string.',
};

export abstract class HtmlStyleElementSyntaxNode extends AbstractHtmlElementSyntaxNode implements IHtmlStyleElementSyntaxNode {
...
export default HtmlStyleElementSyntaxNode;