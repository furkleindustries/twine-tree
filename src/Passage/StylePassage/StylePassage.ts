import {
  CssImportLink,
} from '../../Link/CssImportLink/CssImportLink';
import {
  isCssImportLink,
} from '../../Link/CssImportLink/isCssImportLink';
import {
  isPosition,
...
export class StylePassage implements IStylePassage {
  ...
  readonly links:              Array<CssImportLink>;
  ...
  constructor(
    ...
    name:                      string,
    source:                    string,
    abstractSyntaxTree:        Stylesheet,
    tags:                      Array<ITag> = [],
    position:                  TPosition = [ -1, -1 ],
    size:                      TSize = [ -1, -1 ],
    links:                     Array<CssImportLink> = [])
  {
    const pass = {
      type: this.type,
    ...
    const isValid = StylePassage.isValid(pass);
